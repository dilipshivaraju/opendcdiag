...
static void format_and_print_message(int fd, int message_level, std::string_view message, std::string_view log_type, bool is_skip_init)
{
    const char *levels[] = { "error", "warning", "info", "debug", "skip" }; //levels for yaml format
