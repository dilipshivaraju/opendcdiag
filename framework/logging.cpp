        ...
        case UserMessages:
            ...
            if (!newline) {
                ...
                if(message[0] == 'S'){
                    ...
                    print_content_single_line(fd, "   - '", skip_message_view, std::string_view(&c, 1));
                }else
...
inline void YamlLogger::print_one_message(int fd, int level, std::string_view message)
{
    ...
    const char *levels[] = { "error", "warning", "info", "debug", "skipped" };
    ...
    for ( ; ptr < end; ptr = delim + 1) {
        ...
        case UserMessages:
            if(message[0] == 'S'){
                ...
                FORMAT_SKIP_MESSAGE(skip_message, message);
                std::string_view skip_message_view(&skip_message[0], skip_message.size());
                print_one_message(fd, 4, skip_message_view);
            }
            else
